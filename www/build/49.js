...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__deals_list__ = __webpack_require__(894);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_mergeMap__ = __webpack_require__(701);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_add_observable_forkJoin__ = __webpack_require__(567);
...
var DealsListPage = /** @class */ (function () {
    function DealsListPage(navCtrl, userdataProvider, storesProvider, analytics, excepProvider, translate, commonProvider) {
        ...
        this.dealsList = [];
        this.specialPromo = [];
        this.currentdate = __WEBPACK_IMPORTED_MODULE_11_moment___default()().format('YYYY-MM-DD');
    ...
    DealsListPage.prototype.getPromotions = function () {
        var _this = this;
        var specialPromo = this.storesProvider.getAllSpecialPromotions();
        var promotion = this.storesProvider.getAllPromotions(true);
        var promotionMerge = __WEBPACK_IMPORTED_MODULE_9_rxjs_Observable__["Observable"].forkJoin(specialPromo, promotion);
        promotionMerge.subscribe(function (promotionList) {
            var specialPromotion = promotionList[0].data.filter(function (sp) {
                sp.isSpecial = true;
                if (sp.displaystartdate && sp.displayenddate && sp.isactive) {
                    var isTrue = _this.commonProvider.canDisplayData(sp.displaystartdate, sp.displayenddate);
                    if (isTrue)
                        return sp;
                }
                else {
            ...
            var dealsList = promotionList[1].data.filter(function (promo) {
                if (promo.displaystartdate && promo.displayenddate && promo.isactive) {
                    var isTrue = _this.commonProvider.canDisplayData(promo.displaystartdate, promo.displayenddate);
                    if (isTrue)
                        return promo;
                }
                else {
            ...
            _this.dealsList = specialPromotion.concat(dealsList);
        }, function (err) {
            console.log(err);
    ...
    DealsListPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__providers_userdata_userdata__["a" /* UserdataProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__providers_userdata_userdata__["a" /* UserdataProvider */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_stores_stores__["a" /* StoresProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_stores_stores__["a" /* StoresProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__providers_analytics_analytics__["a" /* AnalyticsProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_analytics_analytics__["a" /* AnalyticsProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6__ngx_translate_core__["c" /* TranslateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ngx_translate_core__["c" /* TranslateService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_7__providers_common_common__["a" /* CommonProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__providers_common_common__["a" /* CommonProvider */]) === "function" && _g || Object])
    ], DealsListPage);
