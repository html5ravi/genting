...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PurchasedItemsPageModule", function() { return PurchasedItemsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__purchased_items__ = __webpack_require__(966);
...
var PurchasedItemsPageModule = /** @class */ (function () {
    function PurchasedItemsPageModule() {
    }
    PurchasedItemsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__purchased_items__["a" /* PurchasedItemsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__purchased_items__["a" /* PurchasedItemsPage */]),
                __WEBPACK_IMPORTED_MODULE_3__app_martjack_shared_module__["a" /* MartJackSharedModule */]
            ],
        })
    ], PurchasedItemsPageModule);
    return PurchasedItemsPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PurchasedItemsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the PurchasedItemsPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var PurchasedItemsPage = /** @class */ (function () {
    function PurchasedItemsPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PurchasedItemsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PurchasedItemsPage');
    };
    PurchasedItemsPage.prototype.gotoPage = function (page) {
        this.navCtrl.push(page);
    };
    PurchasedItemsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-purchased-items',template:/*ion-inline-start:"/Applications/MAMP/htdocs/genting/src/pages/purchased-items/purchased-items.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-row>\n          <ion-col col-2>\n              <ion-icon name="arrow-back" class="backIco" (click)="gotoPage(\'HomePage\')"></ion-icon>\n          </ion-col>\n          <ion-col col-8>\n              <figure no-margin>\n                  <strong>purchased items</strong>\n              </figure>\n          </ion-col>\n      <!-- <ion-col col-2>\n          <button ion-button icon-only menuToggle>\n          <ion-icon tappable name="menu"></ion-icon>\n        </button>\n      </ion-col> -->\n        </ion-row>\n    </ion-navbar>\n  </ion-header>\n\n\n\n<ion-content no-padding>\n  <ion-card padding>\n    <article>\n      <p>You have 3 items to be collected at <br />\n      <strong>Genting Highlands Premium Outlets</strong>\n      11 may 2018</p>\n    </article>\n    <ion-grid no-padding class="number">\n      <ion-row>\n        <ion-col>\n          <p>order number <strong>1234567</strong></p>\n        </ion-col>\n        <ion-col text-right>\n            <p>date ordered <strong>2 may 2018</strong></p>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </ion-card>\n  <hr />\n  <ion-card padding>\n      <item-list (click)="gotoPage(\'ItemDetailsPage\')"></item-list>\n      <item-list></item-list>\n      <item-list></item-list>\n      <item-list></item-list>\n  </ion-card>\n  \n</ion-content>\n'/*ion-inline-end:"/Applications/MAMP/htdocs/genting/src/pages/purchased-items/purchased-items.html"*/,
        }),
