...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_martjack_main_slider_main_slider__ = __webpack_require__(948);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_martjack_main_navs_main_navs__ = __webpack_require__(949);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_martjack_promotion_list_promotion_list__ = __webpack_require__(950);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_martjack_shared_module__ = __webpack_require__(942);
    ...
    HomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__components_martjack_main_slider_main_slider__["a" /* MainSliderComponent */],
                __WEBPACK_IMPORTED_MODULE_7__components_martjack_main_navs_main_navs__["a" /* MainNavsComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components_martjack_promotion_list_promotion_list__["a" /* PromotionListComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__home__["a" /* HomePage */]),
                __WEBPACK_IMPORTED_MODULE_3__app_shared_module__["a" /* SharedModule */],
                __WEBPACK_IMPORTED_MODULE_4__app_ibeacon_module__["a" /* IBeaconModule */],
                __WEBPACK_IMPORTED_MODULE_9__app_martjack_shared_module__["a" /* MartJackSharedModule */]
            ],
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"/Applications/MAMP/htdocs/genting/src/pages/home/home.html"*/'\n<ion-header>\n    <ion-navbar>\n      <ion-row>\n        <ion-col col-2>\n          <!-- <button *ngIf="auth_token" ion-button icon-only icon-left (click)="navTo(\'FullProfilePage\')">\n          <ion-icon class="profile-icon" name="md-person" color="yellow"></ion-icon>\n        </button> -->\n        </ion-col>\n        <ion-col col-8>\n            <figure no-margin>\n                <img src="{{malllogo}}"/>\n              </figure>\n        </ion-col>\n        <ion-col col-2>\n            <button ion-button icon-only menuToggle>\n                <ion-icon tappable name="menu"></ion-icon>\n              </button>\n        </ion-col>\n      </ion-row>\n    </ion-navbar>\n  </ion-header>\n  <!-- <header [canShowMenu]=true [showBackButton]=false [showProfileIcon]=auth_token?true:false></header> -->\n\n<ion-content no-padding no-bounce has-bouncing="false" overflow-scroll="false">\n  <!-- <section class="fixeHeight" style="min-height: 90vw;"> -->\n      <main-slider></main-slider>\n    <!-- <ion-slides *ngIf="homeBannerData.length > 0" pager="true" autoplay="5000" loop="true" speed="1000" class="static">\n      <ion-slide *ngFor="let banner of homeBannerData | sort:\'priority\'" (click)="navTo(banner)"> \n        <section>\n          <figure no-margin >\n            <a *ngIf="banner?.linktype ==\'InAppLink\'" href="#{{banner?.destination}}"><img [src]="banner?.bannerimage" /></a>\n            <a *ngIf="banner?.linktype ==\'None\'"><img [src]="banner?.bannerimage" /></a>\n            <a *ngIf="banner?.linktype ==\'WebLink\'" href="{{banner?.destination}}"><img [src]="banner?.bannerimage" /></a>\n          </figure>\n        </section>\n      </ion-slide>\n    </ion-slides> -->\n  <!-- </section> -->\n  <main-navs></main-navs>\n  <promotion-list></promotion-list>\n  <!-- <bottom-menu [pagename]="\'HomePage\'"></bottom-menu> -->\n\n  <!-- <article>\n    <section class="timePatch">\n      <strong>{{ "HOMEPAGE.STATIC_TEXT.OPEN" | translate }}</strong>\n    </section>\n  <ion-card-content>\n    <h3 text-uppercase class="pr" *ngIf="storeList.length > 0">{{ "HOMEPAGE.STATIC_TEXT.STORES_AROUND" | translate }}</h3>\n    <ul class="sliderWrap">\n      <li  tappable *ngFor="let store of storeList" (click)="fullstore(store?.associatedstore[0])">\n          <figure>\n            <img [src]="store?.associatedstore[0]?.brandimage" />\n          </figure>\n          <figcaption>{{store?.associatedstore[0]?.storename}}</figcaption>\n      </li>\n    </ul>\n\n    <ul class="second" *ngIf="storeList.length <= 0">\n        <li class="dark chClr">\n          <a href="{{mall?.facebookurl}}" target="_blank">\n            <strong>\n                <p no-margin><span>{{mall?.mallname}}</span> <br /> {{ "HOMEPAGE.STATIC_TEXT.ON" | translate }} <br> {{ "HOMEPAGE.STATIC_TEXT.FACEBOOK" | translate }} <br> <a href="{{mall?.facebookurl}}" target="_blank">{{ "HOMEPAGE.STATIC_TEXT.LIKE_US" | translate }} </a></p>\n            </strong>\n          </a>\n        </li>\n        <li class="dark">\n          <a href="{{mall?.instagramurl}}" target="_blank">\n            <strong>\n                <p no-margin><span>{{mall?.mallname}}</span> <br> {{ "HOMEPAGE.STATIC_TEXT.ON" | translate }} <br> {{ "HOMEPAGE.STATIC_TEXT.INSTAGRAM" | translate }} <br> <a href="{{mall?.instagramurl}}" target="_blank">{{ "HOMEPAGE.STATIC_TEXT.LIKE_US" | translate }} </a>\n            </strong>\n          </a>\n        </li>\n      </ul>\n\n\n  </ion-card-content>\n</article> -->\n</ion-content>\n\n\n<mymodal #bluetooth title="Turn on Bluetooth" (closeClicked)="closeBluetoothModal()">\n  <ion-grid>\n    <div>\n        <p text-center>{{ "MODALS.STATIC_TEXT.BLUETOOTH_1" | translate }} <ion-icon ios="ios-bluetooth" md="md-bluetooth"></ion-icon> {{ "MODALS.STATIC_TEXT.BLUETOOTH_2" | translate }}”</p>\n  </div>\n      <ion-row>\n          <ion-col col-12>\n              <button ion-button color="dark" (click)="openBluetoothSettings()">\n                {{ "MODALS.BUTTONS.SETTINGS" | translate }}</button>\n          </ion-col>\n      </ion-row>\n  </ion-grid>\n</mymodal>\n'/*ion-inline-end:"/Applications/MAMP/htdocs/genting/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__providers_stores_stores__["a" /* StoresProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_stores_stores__["a" /* StoresProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__providers_beacon_beacon__["a" /* BeaconProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_beacon_beacon__["a" /* BeaconProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__providers_userdata_userdata__["a" /* UserdataProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_userdata_userdata__["a" /* UserdataProvider */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_6__ionic_native_open_native_settings__["a" /* OpenNativeSettings */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ionic_native_open_native_settings__["a" /* OpenNativeSettings */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_7__providers_geofence_geofence__["a" /* GeofenceProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__providers_geofence_geofence__["a" /* GeofenceProvider */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */]) === "function" && _l || Object, typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_8__providers_analytics_analytics__["a" /* AnalyticsProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__providers_analytics_analytics__["a" /* AnalyticsProvider */]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_9__ngx_translate_core__["c" /* TranslateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__ngx_translate_core__["c" /* TranslateService */]) === "function" && _o || Object, typeof (_p = typeof __WEBPACK_IMPORTED_MODULE_10__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_10__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */]) === "function" && _p || Object])
    ], HomePage);
    return HomePage;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MainSliderComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_stores_stores__ = __webpack_require__(877);
...
var MainSliderComponent = /** @class */ (function () {
    function MainSliderComponent(storesProvider, zone, excepProvider, navCtrl) {
        this.storesProvider = storesProvider;
        this.zone = zone;
        this.excepProvider = excepProvider;
        this.navCtrl = navCtrl;
    ...
    MainSliderComponent.prototype.ionViewWillEnter = function () {
        console.log("Will enter main slider");
    };
    MainSliderComponent.prototype.getHomeBanners = function () {
        var _this = this;
        this.storesProvider.getHomeBanners().subscribe(function (homebanners) {
            console.log(homebanners, "m-home sliderrrrr");
    ...
    MainSliderComponent.prototype.navTo = function (page) {
        this.navCtrl.setRoot(page);
    };
    MainSliderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'main-slider',template:/*ion-inline-start:"/Applications/MAMP/htdocs/genting/src/components/martjack/main-slider/main-slider.html"*/'\n  <ion-slides *ngIf="homeBannerData.length > 0" pager="true" autoplay="5000" loop="true" speed="1000">\n    <ion-slide *ngFor="let banner of homeBannerData | sort:\'priority\'" (click)="navTo(banner)">\n      <section>\n        <figure no-margin >\n          <a *ngIf="banner?.linktype ==\'InAppLink\'" href="#{{banner?.destination}}"><img [src]="banner?.bannerimage" /></a>\n          <a *ngIf="banner?.linktype ==\'None\'"><img [src]="banner?.bannerimage" /></a>\n          <a *ngIf="banner?.linktype ==\'WebLink\'" href="{{banner?.destination}}"><img [src]="banner?.bannerimage" /></a>\n        </figure>\n      </section>\n    </ion-slide>\n    <!-- <ion-slide>\n      <figure>\n          <img src="assets/images/martjack/banner2.png"/>\n        <figcaption>shop & <br /> <span>pick up</span></figcaption>\n      </figure>\n    </ion-slide>\n    <ion-slide>\n      <figure>\n          <img src="assets/images/martjack/aboutGentingsimon.jpg"/>\n        <figcaption>shop & <br /> <span>pick up</span></figcaption>\n      </figure>\n    </ion-slide> -->\n  </ion-slides>\n\n'/*ion-inline-end:"/Applications/MAMP/htdocs/genting/src/components/martjack/main-slider/main-slider.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__providers_stores_stores__["a" /* StoresProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_stores_stores__["a" /* StoresProvider */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_exception_handler_exception_handler__["a" /* ExceptionHandlerProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */]) === "function" && _d || Object])
    ], MainSliderComponent);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MainNavsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var MainNavsComponent = /** @class */ (function () {
    function MainNavsComponent(navCtrl, navParms, navParams) {
        this.navCtrl = navCtrl;
        this.navParms = navParms;
        this.navParams = navParams;
        console.log('Hello MainNavsComponent Component');
    }
    MainNavsComponent.prototype.goto = function (page) {
        this.navCtrl.setRoot(page);
    };
    MainNavsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'main-navs',template:/*ion-inline-start:"/Applications/MAMP/htdocs/genting/src/components/martjack/main-navs/main-navs.html"*/'<ion-card no-margin>\n    <ion-grid>\n        <ion-row>\n            <ion-col text-center>\n                <figure (click)="goto(\'ShopPage\')">\n                    <img src="assets/images/martjack/nav1.png" style="width:17px;">\n                    <figcaption>\n                        shop & <br> pick up\n                    </figcaption>\n                </figure>\n            </ion-col>\n            <ion-col text-center>\n                <figure (click)="goto(\'DealsPage\')">\n                    <img src="assets/images/martjack/nav2.png" style="width:30px;">\n                    <figcaption>\n                            Deals & <br /> Offers\n                    </figcaption>\n                </figure>\n            </ion-col>\n            <ion-col text-center>\n                <figure (click)="goto(\'StoreDirectoryPage\')">\n                    <img src="assets/images/martjack/nav3.png">\n                    <figcaption>\n                            Find a <br /> Store\n                    </figcaption>\n                </figure>\n            </ion-col>\n            <ion-col text-center>\n                <figure (click)="goto(\'MapsPage\')">\n                    <img src="assets/images/martjack/nav4.png">\n                    <figcaption>\n                        center <br /> map\n                    </figcaption>\n                </figure>\n            </ion-col>\n        </ion-row>\n    </ion-grid>\n</ion-card>\n'/*ion-inline-end:"/Applications/MAMP/htdocs/genting/src/components/martjack/main-navs/main-navs.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]) === "function" && _c || Object])
    ], MainNavsComponent);
    return MainNavsComponent;
    var _a, _b, _c;
}());

//# sourceMappingURL=main-navs.js.map
...
/**
 * Generated class for the PromotionListComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var PromotionListComponent = /** @class */ (function () {
    function PromotionListComponent() {
        console.log('Hello PromotionListComponent Component');
        this.text = 'Hello World';
    }
    PromotionListComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'promotion-list',template:/*ion-inline-start:"/Applications/MAMP/htdocs/genting/src/components/martjack/promotion-list/promotion-list.html"*/'<section class="promotionList">\n    <ul>\n        <li>\n            <figure>\n                <img src="assets/images/martjack/promo1.png" />\n                <figcaption> 30% Off Entire <br /> Purchase</figcaption>\n            </figure>\n        </li>\n        <li>\n            <figure>\n                <img src="assets/images/martjack/promo2.png" />\n                <figcaption> 30% Off Entire <br /> Purchase</figcaption>\n            </figure>\n        </li>\n        <li>\n            <figure>\n                <img src="assets/images/martjack/promo1.png" />\n                <figcaption> 30% Off Entire <br /> Purchase</figcaption>\n            </figure>\n        </li>\n        <li>\n            <figure>\n                <img src="assets/images/martjack/promo2.png" />\n                <figcaption> 30% Off Entire <br /> Purchase</figcaption>\n            </figure>\n        </li>\n    </ul>\n</section>\n'/*ion-inline-end:"/Applications/MAMP/htdocs/genting/src/components/martjack/promotion-list/promotion-list.html"*/
        }),
        __metadata("design:paramtypes", [])
...
//# sourceMappingURL=promotion-list.js.map
