...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__promotion_banner__ = __webpack_require__(918);
...
var VouchersProvider = /** @class */ (function () {
    ...
    VouchersProvider.prototype.issueVouchers = function (userEmail, expId, authKey) {
        ...
        userData.append('brand_identifier', __WEBPACK_IMPORTED_MODULE_1__config__["c" /* BRAND_ID */]);
        ...
        return this.httpClient.post(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* BASE_URL */] + __WEBPACK_IMPORTED_MODULE_2__url__["k" /* ISSUE_VOUCHER */], userData, { headers: new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', authKey) })
    ...
    VouchersProvider.prototype.redeemVouchers = function (userEmail, couponCode, authKey) {
        ...
        return this.httpClient.post(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* BASE_URL */] + __WEBPACK_IMPORTED_MODULE_2__url__["t" /* REDEEM_EXPERIENCES */], userData, { headers: new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', authKey) })
            .catch(function (err) { return __WEBPACK_IMPORTED_MODULE_5_rxjs_Observable__["Observable"].throw(err); })
            .finally(function () { return _this.loaderProvider.dismissLoader(loader); });
    };
    ...
    VouchersProvider.prototype.getRedeemedVouchers = function (userEmail, authKey) {
        ...
        var loader = this.loaderProvider.presentLoadingCustom();
        loader.present();
        return this.httpClient.get(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* BASE_URL */] + __WEBPACK_IMPORTED_MODULE_2__url__["s" /* REDEEMED_VOUCHERS */] + userEmail + '&identifier_key=email' + '&brand_identifier=' + __WEBPACK_IMPORTED_MODULE_1__config__["c" /* BRAND_ID */], { headers: new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["c" /* HttpHeaders */]().set('Authorization', authKey) })
            .catch(function (err) { return __WEBPACK_IMPORTED_MODULE_5_rxjs_Observable__["Observable"].throw(err); })
            .finally(function () { return _this.loaderProvider.dismissLoader(loader); });
    };
